    ...
    module ProductFilters
      ...
      def ProductFilters.price_filter
        ...
        conds = [ [ Spree.t(:under_price, price: format_price(100))     , v[:amount].lteq(100)],
                  ...
                  [ "#{format_price(250)} - #{format_price(400)}"        , v[:amount].in(250..400)],
                  [ "#{format_price(400)} - #{format_price(600)}"        , v[:amount].in(400..600)],
                  [ "#{format_price(600)} - #{format_price(800)}"        , v[:amount].in(600..800)],
                  [ Spree.t(:or_over_price, price: format_price(800)) , v[:amount].gteq(800)]]
        {
